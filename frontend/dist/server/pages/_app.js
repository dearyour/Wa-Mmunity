...
const GetUserurl = "https://j6a101.p.ssafy.io/api/" + "member/";
...
const Feedurl = (/* unused pure expression or super */ null && ("https://j6a101.p.ssafy.io/api/" + "/wine"));
const placeHolderurl = (/* unused pure expression or super */ null && ("https://j6a101.p.ssafy.io/api/" + "/feed"));
const GetFeedState = () => {
  return external_axios_default()({
    method: "GET",
    url: "https://j6a101.p.ssafy.io/api/" + "wine" // url: "http://j6a101.p.ssafy.io:8080/api/wine",
